// Auto-generated barrel: the public API of ngk-dashboard.
// Primitives
...
export * from './components/ui/skeleton-page'
...
export { LongText } from './components/long-text'
export { PasswordInput } from './components/password-input'
// Utilities & hooks
export { cn, sleep, getPageNumbers, getDisplayNameInitials } from './lib/utils'
